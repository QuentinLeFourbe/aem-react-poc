...
function d(e, t) {
	...
	if (o) {
		...
		} else if (!h(t.queryKey, o)) return !1;
	}
	if (n !== "all") {
		let e = t.isActive();
...
function f(e, t) {
	...
	if (a) {
		...
		} else if (!h(t.options.mutationKey, a)) return !1;
	}
...
function h(e, t) {
	return e === t ? !0 : typeof e == typeof t && e && t && typeof e == "object" && typeof t == "object" ? Object.keys(t).every((n) => h(e[n], t[n])) : !1;
}
...
function _(e, t, n = 0) {
	...
	if (n > 500) return t;
	let r = y(e) && y(t);
	if (!r && !(b(e) && b(t))) return t;
	let i = (r ? e : Object.keys(e)).length, a = r ? t : Object.keys(t), o = a.length, s = r ? Array(o) : {}, c = 0;
	for (let l = 0; l < o; l++) {
		let o = r ? l : a[l], u = e[o], d = t[o];
		if (u === d) {
			s[o] = u, (r ? l < i : g.call(e, o)) && c++;
			continue;
		}
...
function b(e) {
	...
	let n = t.prototype;
	return !(!x(n) || !n.hasOwnProperty("isPrototypeOf") || Object.getPrototypeOf(e) !== Object.prototype);
}
function x(e) {
...
function C(e, t, n) {
	return typeof n.structuralSharing == "function" ? n.structuralSharing(e, t) : n.structuralSharing === !1 ? t : _(e, t);
}
function w(e, t, n = 0) {
	let r = [...e, t];
...
function D(e, t) {
	return !e.queryFn && t?.initialPromise ? () => t.initialPromise : !e.queryFn || e.queryFn === E ? () => Promise.reject(/* @__PURE__ */ Error(`Missing queryFn: '${e.queryHash}'`)) : e.queryFn;
}
function O(e, t) {
	return typeof e == "function" ? e(...t) : !!e;
}
...
var N = ee(), P = new class extends e {
	#e = !0;
	#t;
	#n;
	constructor() {
...
function R(e) {
	let t = !1, n = 0, r, a = j(), o = () => a.status !== "pending", s = (t) => {
		if (!o()) {
			let n = new L(t);
			p(n), e.onCancel?.(n);
		}
		...
		t = !1;
	}, u = () => A.isFocused() && (e.networkMode === "always" || P.isOnline()) && e.canRun(), d = () => I(e.networkMode) && e.canRun(), f = (e) => {
		o() || (r?.(), a.resolve(e));
	}, p = (e) => {
		o() || (r?.(), a.reject(e));
	}, m = () => new Promise((t) => {
		...
		if (o()) return;
		let r, a = n === 0 ? e.initialPromise : void 0;
		try {
			r = a ?? e.fn();
		} catch (e) {
			r = Promise.reject(e);
		...
		Promise.resolve(r).then(f).catch((r) => {
			if (o()) return;
			let a = e.retry ?? (i ? 0 : 3), s = e.retryDelay ?? F, c = typeof s == "function" ? s(n, r) : s, l = a === !0 || typeof a == "number" && n < a || typeof a == "function" && a(n, r);
			if (t || !l) {
				p(r);
				return;
			}
			n++, e.onFail?.(n, r), S(c).then(() => u() ? void 0 : m()).then(() => {
				t ? p(r) : h();
			});
		});
	};
...
var z = class {
	...
	scheduleGc() {
		this.clearGcTimeout(), s(this.gcTime) && (this.#e = n.setTimeout(() => {
			this.optionalRemove();
		}, this.gcTime));
	}
	updateGcTime(e) {
		this.gcTime = Math.max(this.gcTime || 0, e ?? (i ? Infinity : 300 * 1e3));
	}
	clearGcTimeout() {
		this.#e &&= (n.clearTimeout(this.#e), void 0);
	}
}, B = class extends z {
	#e;
	#t;
	...
	#o;
	constructor(e) {
		super(), this.#o = !1, this.#a = e.defaultOptions, this.setOptions(e.options), this.observers = [], this.#r = e.client, this.#n = this.#r.getQueryCache(), this.queryKey = e.queryKey, this.queryHash = e.queryHash, this.#e = U(this.options), this.state = e.state ?? this.#e, this.scheduleGc();
	}
	get meta() {
	...
	setOptions(e) {
		if (this.options = {
			...
			e.data !== void 0 && (this.setState(H(e.data, e.dataUpdatedAt)), this.#e = e);
		}
	}
	optionalRemove() {
	...
	isActive() {
		return this.observers.some((e) => u(e.options.enabled, this) !== !1);
	}
	isDisabled() {
	...
	isStatic() {
		return this.getObserversCount() > 0 ? this.observers.some((e) => l(e.options.staleTime, this) === "static") : !1;
	}
	isStale() {
...
var W = class extends e {
	...
	onSubscribe() {
		this.listeners.size === 1 && (this.#t.addObserver(this), K(this.#t, this.options) ? this.#h() : this.updateResult(), this.#y());
	}
	onUnsubscribe() {
		this.hasListeners() || this.destroy();
	}
	shouldFetchOnReconnect() {
		return q(this.#t, this.options, this.options.refetchOnReconnect);
	}
	...
	setOptions(e) {
		...
		this.#S(), this.#t.setOptions(this.options), t._defaulted && !v(this.options, t) && this.#e.getQueryCache().notify({
			type: "observerOptionsUpdated",
			query: this.#t,
			observer: this
		});
		let r = this.hasListeners();
		r && J(this.#t, n, this.options, t) && this.#h(), this.updateResult(), r && (this.#t !== n || u(this.options.enabled, this.#t) !== u(t.enabled, this.#t) || l(this.options.staleTime, this.#t) !== l(t.staleTime, this.#t)) && this.#g();
		let i = this.#_();
		r && (this.#t !== n || u(this.options.enabled, this.#t) !== u(t.enabled, this.#t) || i !== this.#p) && this.#v(i);
	}
	getOptimisticResult(e) {
		let t = this.#e.getQueryCache().build(this.#e, e), n = this.createResult(t, e);
		return X(this, n) && (this.#r = n, this.#a = this.options, this.#i = this.#t.state), n;
	}
	getCurrentResult() {
		return this.#r;
	}
	...
	#g() {
		...
		if (i || this.#r.isStale || !s(e)) return;
	...
	#v(e) {
		this.#x(), this.#p = e, !(i || u(this.options.enabled, this.#t) === !1 || !s(this.#p) || this.#p === 0) && (this.#f = n.setInterval(() => {
	...
	#b() {
		this.#d &&= (n.clearTimeout(this.#d), void 0);
	}
	#x() {
		this.#f &&= (n.clearInterval(this.#f), void 0);
	}
	createResult(e, t) {
		let n = this.#t, r = this.options, i = this.#r, a = this.#i, o = this.#a, s = e === n ? this.#n : e.state, { state: c } = e, l = { ...c }, d = !1, f;
		if (t._optimisticResults) {
			let i = this.hasListeners(), a = !i && K(e, t), o = i && J(e, n, t, r);
			(a || o) && (l = {
				...l,
				...V(c.data, e.options)
		...
		if (t.placeholderData !== void 0 && f === void 0 && h === "pending") {
			let e;
			i?.isPlaceholderData && t.placeholderData === o?.placeholderData ? (e = i.data, g = !0) : e = typeof t.placeholderData == "function" ? t.placeholderData(this.#u?.state.data, this.#u) : t.placeholderData, e !== void 0 && (h = "success", f = C(i?.data, e, t), d = !0);
		}
		if (t.select && f !== void 0 && !g) if (i && f === a?.data && t.select === this.#c) f = this.#l;
		else try {
			this.#c = t.select, f = t.select(f), f = C(i?.data, f, t), this.#l = f, this.#s = null;
		} catch (e) {
			this.#s = e;
		}
		this.#s && (p = this.#s, f = this.#l, m = Date.now(), h = "error");
		let _ = l.fetchStatus === "fetching", v = h === "pending", y = h === "error", b = v && _, x = f !== void 0, S = {
			status: h,
	...
	updateResult() {
		...
		this.#i = this.#t.state, this.#a = this.options, this.#i.data !== void 0 && (this.#u = this.#t), !v(t, e) && (this.#r = t, this.#C({ listeners: (() => {
			if (!e) return !0;
...
function G(e, t) {
	return u(t.enabled, e) !== !1 && e.state.data === void 0 && !(e.state.status === "error" && t.retryOnMount === !1);
}
function K(e, t) {
	return G(e, t) || e.state.data !== void 0 && q(e, t, t.refetchOnMount);
}
function q(e, t, n) {
	if (u(t.enabled, e) !== !1 && l(t.staleTime, e) !== "static") {
		let r = typeof n == "function" ? n(e) : n;
		return r === "always" || r !== !1 && Y(e, t);
	}
	return !1;
}
function J(e, t, n, r) {
	return (e !== t || u(r.enabled, e) === !1) && (!n.suspense || e.state.status !== "error") && Y(e, n);
}
function Y(e, t) {
	return u(t.enabled, e) !== !1 && e.isStaleByTime(l(t.staleTime, e));
}
function X(e, t) {
...
function Z(e) {
	return { onFetch: (t, n) => {
		let r = t.options, i = t.fetchOptions?.meta?.fetchMore?.direction, a = t.state.data?.pages || [], o = t.state.data?.pageParams || [], s = {
			...
			let n = !1, l = (e) => {
				k(e, () => t.signal, () => n = !0);
			}, u = D(t.options, t.fetchOptions), d = async (e, r, i) => {
			...
			if (i && a.length) {
				...
				let t = e ?? a.length;
				do {
					let e = c === 0 ? o[0] ?? r.initialPageParam : Q(r, s);
					if (c > 0 && e == null) break;
					s = await d(s, e), c++;
				} while (c < t);
			}
...
function Q(e, { pages: t, pageParams: n }) {
	let r = t.length - 1;
...
var ie = class extends e {
	...
	find(e) {
		...
		return this.getAll().find((e) => f(t, e));
	}
	findAll(e = {}) {
		return this.getAll().filter((t) => f(e, t));
	}
	notify(e) {
		N.batch(() => {
			this.listeners.forEach((t) => {
	...
	resumePausedMutations() {
		...
		return N.batch(() => Promise.all(e.map((e) => e.continue().catch(a))));
	}
};
function $(e) {
...
var ae = class extends e {
	...
	findAll(e = {}) {
		let t = this.getAll();
		return Object.keys(e).length > 0 ? t.filter((t) => d(e, t)) : t;
	}
	notify(e) {
		N.batch(() => {
			this.listeners.forEach((t) => {
	...
	#s;
	constructor(e = {}) {
		this.#e = e.queryCache || new ae(), this.#t = e.mutationCache || new ie(), this.#n = e.defaultOptions || {}, this.#r = /* @__PURE__ */ new Map(), this.#i = /* @__PURE__ */ new Map(), this.#a = 0;
	}
	mount() {
	...
	ensureQueryData(e) {
		...
		return r === void 0 ? this.fetchQuery(e) : (e.revalidateIfStale && n.isStaleByTime(l(t.staleTime, n)) && this.prefetchQuery(t), Promise.resolve(r));
	}
	getQueriesData(e) {
	...
	fetchQuery(e) {
		...
		return n.isStaleByTime(l(t.staleTime, n)) ? n.fetch(t) : Promise.resolve(n.state.data);
	}
	prefetchQuery(e) {
		return this.fetchQuery(e).then(a).catch(a);
	}
	fetchInfiniteQuery(e) {
		return e.behavior = Z(e.pages), this.fetchQuery(e);
	}
	prefetchInfiniteQuery(e) {
		return this.fetchInfiniteQuery(e).then(a).catch(a);
	}
	ensureInfiniteQueryData(e) {
		return e.behavior = Z(e.pages), this.ensureQueryData(e);
	}
	resumePausedMutations() {
	...
	getQueryDefaults(e) {
		...
		return t.forEach((t) => {
			h(e, t.queryKey) && Object.assign(n, t.defaultOptions);
		}), n;
	}
	...
	getMutationDefaults(e) {
		...
		return t.forEach((t) => {
			h(e, t.mutationKey) && Object.assign(n, t.defaultOptions);
		}), n;
	}
	defaultQueryOptions(e) {
		...
		return t.queryHash ||= p(t.queryKey, t), t.refetchOnReconnect === void 0 && (t.refetchOnReconnect = t.networkMode !== "always"), t.throwOnError === void 0 && (t.throwOnError = !!t.suspense), !t.networkMode && t.persister && (t.networkMode = "offlineFirst"), t.queryFn === E && (t.enabled = !1), t;
	}
...
//#endregion
export { a, i, W as n, O as o, N as r, oe as t };
